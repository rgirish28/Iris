...
public class HoughCircle extends Thread {
	...
	public HoughCircle(int[] orig,int width,int height,int radius, int threadnum, IrisRecognition irisRecognition){
		this.orig = orig ;
		this.width = width ;
		this.height = height ;
		this.radius = radius ;
	...
	public void run() {
		HoughTransform circHobj = new HoughTransform();
